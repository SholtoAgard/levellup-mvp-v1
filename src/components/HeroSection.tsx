  ...
  return <div className="min-h-[calc(100vh-64px)] flex flex-col items-center justify-start px-4 py-12 text-black">
      <div className="w-full max-w-6xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-6">
          ...
          <p className="text-xl text-[#222222] max-w-2xl mx-auto">Get better at sales within 30 days - AI sales coaching that sharpens your skills instantly.</p>
          <div className="mt-8">
            <Button size="lg" className="bg-[#1E90FF] hover:bg-[#1E90FF]/90 text-white text-lg px-8 py-6 h-auto rounded-xl" onClick={() => navigate('/subscription')}>
